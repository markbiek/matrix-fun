 ...
 * @returns  The result of the addition.
 */
export function subtract(a: number[][], b: number[][]): number[][] | null {
	return addOrSubstract(a, b, -1);
}

export function addOrSubstract(a: number[][], b: number[][], sign: 1 | -1): number[][] | null {
 ...
 */
export function mult(a: number[][], b: number[][]): number[][] | null {
